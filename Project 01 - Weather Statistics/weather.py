...
class WeatherStatistics:
    ...
    def _update(self):
        ...
        text_x = self.datetime_array[start_idx] + \
            (self.datetime_array[end_idx] - self.datetime_array[start_idx])/2
        text_y = self.barpress_array[start_idx] + \
            (self.barpress_array[end_idx] - self.barpress_array[start_idx])/2
